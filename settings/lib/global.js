...
exports.playVideo2 = (data) => {
  return `${data.resultado[0].title} *(Baixado por BLUX-BOT)*`
}
...
exports.result_APOD = (datablux, resultExp) => {
return `🔭 Título - ${datablux.nasa.title}\n\n🌐📝 Explicação - ${resultExp.result}`
}
...
return `${teks.titulo} (Baixado por BLUX-BOT)`
}
...
return `[ 🍓 ] - Oops! não encontrei o comando '${prefix}' em meu sistema que tal dar uma olhadinha no menu e tentar de novo?`
}
...
exports.speedblux = (tempo, sender, r, kyun, uptime, infoSystem, reqcmd) => {
